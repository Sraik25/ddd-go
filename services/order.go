...
import (
	...
	"github.com/Sraik25/ddd-go/domain/customer/mongo"

	"github.com/Sraik25/ddd-go/aggregate"
	"github.com/Sraik25/ddd-go/domain/customer"
	"github.com/Sraik25/ddd-go/domain/customer/memory"
	"github.com/Sraik25/ddd-go/domain/product"
	prodmemory "github.com/Sraik25/ddd-go/domain/product/memory"
)
...
func WithMemoryProductRepository(products []aggregate.Product) OrderConfiguration {
	return func(os *OrderService) error {
		// Create the memory repo, if we need parameters, such as connection strings they could be inputted here
		pr := prodmemory.New()
		// Add Items to repo
...
func (o *OrderService) CreateOrder(customerID uuid.UUID, productIDs []uuid.UUID) (float64, error) {
	...
	// All Products existing in store, now we can create the order
